...
function OwnerParkingDetails() {
  ...
  const loadParkingDetails = async (isRefresh = false) => {
    try {
      if (isRefresh) {
        setRefreshing(true);
      } else {
      ...
      const response = await axios.get(`/parking/owner/${id}`);

      setParking(response.data);
    } catch (error) {
      console.error("Unable to load parking details:", error);
  ...
  // =====================================================
  // CORRECT BACKEND SLOT STATISTICS
  // =====================================================

  const slots = parking.slot_statistics || {};

  const totalSlots =
    slots.configured_capacity || parking.total_slots || 0;

  const createdSlots =
    slots.created_slots || 0;

  const availableSlots =
    slots.available_slots || 0;

  const occupiedSlots =
    slots.occupied_slots || 0;

  const maintenanceSlots =
    slots.maintenance_slots || 0;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-20 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => loadParkingDetails(true)}
                disabled={refreshing}
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                onClick={() =>
                  navigate(
                    `/owner/parking/${parking.id}/slots`
                  )
                }
                className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-slate-900 text-white font-semibold hover:bg-slate-800 transition"
              >
                <FaLayerGroup />
                Manage Slots
              </button>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  Your parking location is currently
                  under review by ParkEase. Customers
                  will be able to discover it after
                  approval.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 mt-1">
                  Your parking location has been
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
              <div>
                ...
                <p className="text-blue-100 mt-2">
                  Add new slots, change availability,
                  mark occupied slots, or put slots
                  under maintenance.
                </p>
              </div>
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white text-blue-700 font-bold hover:bg-blue-50 transition"
              >
                <FaLayerGroup />
                Manage Slots
              </button>
