...
export default function ScanQR() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f8] dark:bg-[#050608] flex flex-col font-sans transition-colors relative selection:bg-emerald-500 selection:text-black dark:selection:bg-emerald-400 dark:selection:text-black overflow-x-hidden">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6 relative z-10 pb-mobile-dock md:pb-8">
        {/* Navigation Bar */}
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-white dark:bg-black border border-zinc-200/90 dark:border-zinc-800 text-xs font-bold text-zinc-900 dark:text-white hover:border-emerald-500/50 transition-all shadow-xs cursor-pointer"
          >
            {soundEnabled ? (
        ...
        {/* Hero Banner Box */}
        <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-black border border-zinc-200/90 dark:border-emerald-500/20 shadow-xl dark:shadow-[0_10px_35px_rgba(0,0,0,0.8)] text-zinc-950 dark:text-white p-6 sm:p-8">
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div className="space-y-1.5">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 text-xs font-black tracking-wide">
              ...
              <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 font-medium">
                Hold customer's digital QR pass under the camera for instantaneous check-in or barrier release.
              </p>
            </div>
            <div className="flex items-center gap-2 text-xs text-zinc-700 dark:text-zinc-300 font-bold bg-zinc-100 dark:bg-zinc-900 px-4 py-2 rounded-2xl border border-zinc-200 dark:border-emerald-500/20">
              <FiRadio className="w-4 h-4 text-emerald-500" />
              <span>Camera Engine Ready</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* SCANNER PANEL */}
          <div className="lg:col-span-6 bg-white dark:bg-black rounded-3xl border border-zinc-200/90 dark:border-zinc-800 shadow-xl p-6 space-y-5">
            <div className="border-b border-zinc-100 dark:border-zinc-800/80 pb-3 flex items-center justify-between">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30">
                12 FPS Live
              </span>
            </div>
              ...
              {!scanning && (
                <div className="text-center p-8 space-y-3">
                  <div className="w-16 h-16 rounded-3xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mx-auto text-zinc-400">
                    <FiCamera className="w-8 h-8 text-emerald-400" />
                  </div>
            ...
            {scanning ? (
              <button
                onClick={stopScanner}
                className="w-full py-3.5 rounded-2xl bg-rose-600 hover:bg-rose-500 text-white text-xs font-black transition-all cursor-pointer shadow-md active:scale-95"
              >
                Stop Camera
              </button>
            ) : (
              <button
                ...
                className="w-full py-3.5 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-black text-xs font-black shadow-lg shadow-emerald-500/25 transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-2"
              >
              ...
              <form onSubmit={handleManualSearch} className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="text-xs font-mono font-bold bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl pl-10 pr-4 py-3 w-full text-zinc-900 dark:text-white focus:outline-none focus:border-emerald-500 dark:focus:border-emerald-400 focus:ring-2 focus:ring-emerald-500/20 shadow-xs placeholder:text-zinc-500"
                  />
                </div>
                <button
                  type="submit"
                  disabled={loading}
                  className="px-5 py-3 rounded-2xl bg-black text-white hover:bg-zinc-900 dark:bg-zinc-900 dark:text-emerald-400 dark:border dark:border-emerald-500/40 text-xs font-black transition-all cursor-pointer shadow-xs active:scale-95"
                >
          ...
          <div className="lg:col-span-6 bg-white dark:bg-black rounded-3xl border border-zinc-200/90 dark:border-zinc-800 shadow-xl p-6 space-y-5">
            ...
            {!verifiedBooking ? (
              <div className="py-20 text-center space-y-3">
                <div className="w-16 h-16 rounded-3xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center mx-auto">
              ...
              <div className="space-y-4 animate-fade-in">
                {/* Status Strip */}
                <div className="p-4 rounded-3xl bg-zinc-50 dark:bg-zinc-950 border border-emerald-500/30 flex items-center justify-between shadow-xs">
                  ...
                  <span className="text-2xl font-black text-zinc-950 dark:text-white bg-white dark:bg-zinc-900 px-4 py-1.5 rounded-2xl border border-emerald-500/30 font-mono shadow-xs">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800">
                  ...
                  <div className="p-3.5 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800">
                    ...
                    <p className="text-xs font-black text-zinc-950 dark:text-white">
                      {isInside ? "🟢 Parked Inside" : "⚪ Checked Out"}
                    </p>
                  </div>
                </div>

                {/* Details Table */}
                <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800 space-y-2.5 text-xs">
                  {[
                    ...
                    <div key={label} className="flex justify-between">
                      ...
                      <span className="font-bold text-zinc-950 dark:text-white">{value}</span>
                    </div>
                  ))}
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-1.5">
                      {[
                        ...
                        <button
                          ...
                          className="px-2.5 py-1.5 rounded-lg bg-white/80 dark:bg-zinc-900 hover:bg-amber-500/20 text-zinc-700 dark:text-zinc-300 hover:text-amber-700 dark:hover:text-amber-300 border border-zinc-200 dark:border-zinc-800 text-[10px] font-bold text-left transition-colors cursor-pointer"
                        >
                          {item.label}
                        </button>
                      ))}
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="py-3.5 px-4 rounded-2xl bg-black text-white hover:bg-zinc-900 dark:bg-zinc-950 dark:text-white border border-zinc-800 dark:border-zinc-700 hover:border-emerald-500/50 font-black text-xs flex items-center justify-center gap-2 shadow-sm transition-all active:scale-95 cursor-pointer"
                  >
                    <FiLogOut className="w-4 h-4 stroke-[2.5]" />
                    <span>{isDaily ? "Exit (Temporary)" : "Let Out (Check Out)"}</span>
                  </button>
                </div>
